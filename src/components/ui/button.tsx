  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-hero text-white font-montserrat font-semibold shadow-button hover:shadow-lg hover:scale-105 transition-bounce",
        brand: "bg-primary text-primary-foreground hover:bg-primary-hover shadow-button",
        creator: "bg-success text-success-foreground hover:bg-success/90 shadow-card",
        cta: "gradient-cta text-warning-foreground font-montserrat font-semibold shadow-button hover:shadow-lg",
